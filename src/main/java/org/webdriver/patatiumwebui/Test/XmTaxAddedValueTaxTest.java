 ...
 * 增值税-增值税及附加税费(增值税)
 */
public class XmTaxAddedValueTaxTest extends TestBaseCase {
...
//		doIndexApplyTax();
	...
	private void doLogin() throws IOException, DocumentException {
		...
		//代替testng参数化的方法
		String BaseUrl= XmlReadUtil.getTestngParametersValue("testngXmTaxAddedValueTax.xml","BaseUrl");
		String userName = XmlReadUtil.getTestngParametersValue("testngXmTaxAddedValueTax.xml","UserName");
		String password = XmlReadUtil.getTestngParametersValue("testngXmTaxAddedValueTax.xml","PassWord");
...
//		indexXmTaxAction.applyAddedValueTax();
	}
}