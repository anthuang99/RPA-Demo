...
//通过解析xml文件自动生成对象库代码
public class PageObjectAutoCodeJinShui {
	Log log=new Log(this.getClass());
	static  String path="org/webdriver/patatiumwebui/pageObjectConfig/UILibraryJinShui.xml";
	public static void autoCode() throws Exception
	{
		...
		try {
			...
			for(Iterator<?> i=root.elementIterator();i.hasNext();)
			{
				...
				sb.append("private String path=\"src/main/java/org/webdriver/patatiumwebui/pageObjectConfig/UILibraryJinShui.xml\";\n");
				...
				Log log=new Log(PageObjectAutoCodeJinShui.class);
	...
	public static void main(String[] args) throws Exception {
		// TODO 自动生成的方法存根
		PageObjectAutoCodeJinShui.autoCode();
	}
