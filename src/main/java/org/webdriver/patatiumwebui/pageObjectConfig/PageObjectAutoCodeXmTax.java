...
//通过解析xml文件自动生成对象库代码
public class PageObjectAutoCodeXmTax {
	Log log=new Log(this.getClass());
	static  String path="org/webdriver/patatiumwebui/pageObjectConfig/UILibraryXmTax.xml";
	public static void autoCode() throws Exception
	{
		InputStream in = null;
		try {
			in = PageObjectAutoCodeXmTax.class.getClassLoader().getResourceAsStream(path);
			...
			for(Iterator<?> i=root.elementIterator();i.hasNext();)
			{
				...
				sb.append("import org.apache.commons.io.IOUtils;\n");
...
//			sb.append("import org.webdriver.patatiumwebui.pageObjectConfig.PageObjectAutoCode;");
				...
				sb.append("private String path=\"org/webdriver/patatiumwebui/pageObjectConfig/UILibraryXmTax.xml\";\n");
...
//			sb.append("getLocatorMap();");
				sb.append(" InputStream in =null;\n");
				sb.append(" try {\n");
				sb.append(" 	in = this.getClass().getClassLoader().getResourceAsStream(path);\n");
				sb.append(" 	setXmlObjectPathForLocator(in);\n");
				sb.append(" 	getLocatorMap();\n");
				sb.append(" } finally {\n");
				sb.append(" 	if (in != null) {\n");
				sb.append(" 		IOUtils.closeQuietly(in);\n");
				sb.append(" 	}\n");
				sb.append(" }\n");
				...
				Log log=new Log(PageObjectAutoCodeXmTax.class);
	...
	public static void main(String[] args) throws Exception {
		// TODO 自动生成的方法存根
		PageObjectAutoCodeXmTax.autoCode();
	}
